...
//   protoc               v6.33.0
// source: vendor/adevtool/assets/response.proto
...
export const CarrierSettings = {
  ...
  fromJSON(object: any): CarrierSettings {
    return {
      ...
      cfg: globalThis.Array.isArray(object?.cfg) ? object.cfg.map((e: any) => CarrierSettings_Configs.fromJSON(e)) : [],
...
export const CarrierSettings_Configs = {
  ...
  fromJSON(object: any): CarrierSettings_Configs {
    return {
      ...
      o: isSet(object.o) ? globalThis.Number(object.o) : 0,
