...
function getFriendlyName(props: PropResults) {
  let product = mapGet(props.stockProps, Partition.Product)
  let manufacturer = mapGet(product, 'ro.product.product.manufacturer')
  let model = mapGet(product, 'ro.product.product.model')
