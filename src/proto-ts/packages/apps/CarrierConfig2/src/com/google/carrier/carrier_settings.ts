...
//   protoc               v6.33.0
// source: packages/apps/CarrierConfig2/src/com/google/carrier/carrier_settings.proto
...
export interface ApnItem {
  ...
  authtype?:
    ...
    | undefined;
  /** MMS configuration. */
  mmsc?: string | undefined;
  mmscProxy?: string | undefined;
  mmscProxyPort?: string | undefined;
  protocol?: ApnItem_Protocol | undefined;
  roamingProtocol?:
    | ApnItem_Protocol
    | undefined;
   ...
   */
  apnSetId?: number | undefined;
  skip464xlat?: ApnItem_Xlat | undefined;
  lingeringNetworkTypeBitmask?: string | undefined;
  alwaysOn?: boolean | undefined;
  mtuV6?: number | undefined;
  infrastructureBitmask?: number | undefined;
  esimBootstrapProvisioning?: number | undefined;
}
...
export interface VendorConfigDataItem {
  key: string;
  textValue?: string | undefined;
}

export interface VendorConfigData {
  configItem: VendorConfigDataItem[];
}
...
export const CarrierSettings = {
  encode(message: CarrierSettings, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.canonicalName !== undefined && message.canonicalName !== "") {
  ...
  fromJSON(object: any): MultiCarrierSettings {
    return {
      ...
      setting: globalThis.Array.isArray(object?.setting)
        ? object.setting.map((e: any) => CarrierSettings.fromJSON(e))
        : [],
      lastUpdated: isSet(object.lastUpdated) ? Timestamp.fromJSON(object.lastUpdated) : undefined,
    };
  },
...
export const ApnItem = {
  encode(message: ApnItem, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    writer.ldelim();
    if (message.bearerBitmask !== undefined && message.bearerBitmask !== "0") {
      writer.uint32(34).string(message.bearerBitmask);
    }
    if (message.server !== undefined && message.server !== "") {
      writer.uint32(42).string(message.server);
    }
    if (message.proxy !== undefined && message.proxy !== "") {
    ...
    if (message.authtype !== undefined && message.authtype !== -1) {
      writer.uint32(80).int32(message.authtype);
    }
    if (message.mmsc !== undefined && message.mmsc !== "") {
      writer.uint32(90).string(message.mmsc);
    }
    if (message.mmscProxy !== undefined && message.mmscProxy !== "") {
      writer.uint32(98).string(message.mmscProxy);
    }
    if (message.mmscProxyPort !== undefined && message.mmscProxyPort !== "") {
    ...
    if (message.roamingProtocol !== undefined && message.roamingProtocol !== 0) {
      writer.uint32(120).int32(message.roamingProtocol);
    }
    if (message.mtu !== undefined && message.mtu !== 0) {
      writer.uint32(128).int32(message.mtu);
    }
    if (message.profileId !== undefined && message.profileId !== 0) {
      writer.uint32(136).int32(message.profileId);
    }
    if (message.maxConns !== undefined && message.maxConns !== 0) {
      writer.uint32(144).int32(message.maxConns);
    }
    if (message.waitTime !== undefined && message.waitTime !== 0) {
      writer.uint32(152).int32(message.waitTime);
    }
    if (message.maxConnsTime !== undefined && message.maxConnsTime !== 0) {
      writer.uint32(160).int32(message.maxConnsTime);
    }
    if (message.modemCognitive !== undefined && message.modemCognitive !== false) {
      writer.uint32(176).bool(message.modemCognitive);
    }
    if (message.userVisible !== undefined && message.userVisible !== true) {
      writer.uint32(184).bool(message.userVisible);
    }
    if (message.userEditable !== undefined && message.userEditable !== true) {
      writer.uint32(192).bool(message.userEditable);
    }
    if (message.apnSetId !== undefined && message.apnSetId !== 0) {
      writer.uint32(200).int32(message.apnSetId);
    }
    if (message.skip464xlat !== undefined && message.skip464xlat !== 0) {
      writer.uint32(208).int32(message.skip464xlat);
    }
    if (message.lingeringNetworkTypeBitmask !== undefined && message.lingeringNetworkTypeBitmask !== "0") {
      writer.uint32(218).string(message.lingeringNetworkTypeBitmask);
    }
    if (message.alwaysOn !== undefined && message.alwaysOn !== false) {
      writer.uint32(224).bool(message.alwaysOn);
    }
    if (message.mtuV6 !== undefined && message.mtuV6 !== 0) {
      writer.uint32(232).int32(message.mtuV6);
    }
    if (message.infrastructureBitmask !== undefined && message.infrastructureBitmask !== 3) {
      writer.uint32(240).int32(message.infrastructureBitmask);
    }
    if (message.esimBootstrapProvisioning !== undefined && message.esimBootstrapProvisioning !== 0) {
      writer.uint32(248).int32(message.esimBootstrapProvisioning);
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 30:
          ...
          message.infrastructureBitmask = reader.int32();
          continue;
        case 31:
          if (tag !== 248) {
            break;
          ...
          message.esimBootstrapProvisioning = reader.int32();
          continue;
      }
      if ((tag & 7) === 4 || tag === 0) {
        break;
  ...
  fromJSON(object: any): ApnItem {
    return {
      ...
      type: globalThis.Array.isArray(object?.type) ? object.type.map((e: any) => apnItem_ApnTypeFromJSON(e)) : [],
      bearerBitmask: isSet(object.bearerBitmask) ? globalThis.String(object.bearerBitmask) : "0",
      ...
      authtype: isSet(object.authtype) ? globalThis.Number(object.authtype) : -1,
      mmsc: isSet(object.mmsc) ? globalThis.String(object.mmsc) : "",
      mmscProxy: isSet(object.mmscProxy) ? globalThis.String(object.mmscProxy) : "",
      mmscProxyPort: isSet(object.mmscProxyPort) ? globalThis.String(object.mmscProxyPort) : "",
      ...
      maxConns: isSet(object.maxConns) ? globalThis.Number(object.maxConns) : 0,
      waitTime: isSet(object.waitTime) ? globalThis.Number(object.waitTime) : 0,
      maxConnsTime: isSet(object.maxConnsTime) ? globalThis.Number(object.maxConnsTime) : 0,
      modemCognitive: isSet(object.modemCognitive) ? globalThis.Boolean(object.modemCognitive) : false,
      userVisible: isSet(object.userVisible) ? globalThis.Boolean(object.userVisible) : true,
      userEditable: isSet(object.userEditable) ? globalThis.Boolean(object.userEditable) : true,
      apnSetId: isSet(object.apnSetId) ? globalThis.Number(object.apnSetId) : 0,
      ...
      lingeringNetworkTypeBitmask: isSet(object.lingeringNetworkTypeBitmask)
        ? globalThis.String(object.lingeringNetworkTypeBitmask)
        : "0",
      alwaysOn: isSet(object.alwaysOn) ? globalThis.Boolean(object.alwaysOn) : false,
      mtuV6: isSet(object.mtuV6) ? globalThis.Number(object.mtuV6) : 0,
      infrastructureBitmask: isSet(object.infrastructureBitmask) ? globalThis.Number(object.infrastructureBitmask) : 3,
      esimBootstrapProvisioning: isSet(object.esimBootstrapProvisioning)
        ? globalThis.Number(object.esimBootstrapProvisioning)
        : 0,
    };
  },
  ...
  toJSON(message: ApnItem): unknown {
    ...
    if (message.infrastructureBitmask !== undefined && message.infrastructureBitmask !== 3) {
      obj.infrastructureBitmask = Math.round(message.infrastructureBitmask);
    }
    if (message.esimBootstrapProvisioning !== undefined && message.esimBootstrapProvisioning !== 0) {
      obj.esimBootstrapProvisioning = Math.round(message.esimBootstrapProvisioning);
    }
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<ApnItem>, I>>(object: I): ApnItem {
    ...
    message.bearerBitmask = object.bearerBitmask ?? "0";
    message.server = object.server ?? "";
    message.proxy = object.proxy ?? "";
    message.port = object.port ?? "";
    message.user = object.user ?? "";
    message.password = object.password ?? "";
    message.authtype = object.authtype ?? -1;
    ...
    message.userVisible = object.userVisible ?? true;
    message.userEditable = object.userEditable ?? true;
    message.apnSetId = object.apnSetId ?? 0;
    message.skip464xlat = object.skip464xlat ?? 0;
    message.lingeringNetworkTypeBitmask = object.lingeringNetworkTypeBitmask ?? "0";
    message.alwaysOn = object.alwaysOn ?? false;
    message.mtuV6 = object.mtuV6 ?? 0;
    message.infrastructureBitmask = object.infrastructureBitmask ?? 3;
    message.esimBootstrapProvisioning = object.esimBootstrapProvisioning ?? 0;
    return message;
  },
};
...
export const CarrierApns = {
  ...
  fromJSON(object: any): CarrierApns {
    return { apn: globalThis.Array.isArray(object?.apn) ? object.apn.map((e: any) => ApnItem.fromJSON(e)) : [] };
  },
...
export const TextArray = {
  ...
  fromJSON(object: any): TextArray {
    return { item: globalThis.Array.isArray(object?.item) ? object.item.map((e: any) => globalThis.String(e)) : [] };
  },
...
export const IntArray = {
  ...
  fromJSON(object: any): IntArray {
    return { item: globalThis.Array.isArray(object?.item) ? object.item.map((e: any) => globalThis.Number(e)) : [] };
  },
  ...
  fromJSON(object: any): CarrierConfig {
    return {
      config: globalThis.Array.isArray(object?.config)
        ? object.config.map((e: any) => CarrierConfig_Config.fromJSON(e))
        : [],
    };
  },
...
export const VendorConfigs = {
  ...
  fromJSON(object: any): VendorConfigs {
    return {
      client: globalThis.Array.isArray(object?.client)
        ? object.client.map((e: any) => VendorConfigClient.fromJSON(e))
        : [],
    };
  },
...
function createBaseVendorConfigDataItem(): VendorConfigDataItem {
  return { key: "", textValue: undefined };
}

export const VendorConfigDataItem = {
  encode(message: VendorConfigDataItem, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.key !== "") {
      writer.uint32(10).string(message.key);
    }
    if (message.textValue !== undefined) {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): VendorConfigDataItem {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseVendorConfigDataItem();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromJSON(object: any): VendorConfigDataItem {
    return {
      key: isSet(object.key) ? globalThis.String(object.key) : "",
      textValue: isSet(object.textValue) ? globalThis.String(object.textValue) : undefined,
    };
  ...
  toJSON(message: VendorConfigDataItem): unknown {
    const obj: any = {};
    if (message.key !== "") {
      obj.key = message.key;
    }
  ...
  create<I extends Exact<DeepPartial<VendorConfigDataItem>, I>>(base?: I): VendorConfigDataItem {
    return VendorConfigDataItem.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<VendorConfigDataItem>, I>>(object: I): VendorConfigDataItem {
    const message = createBaseVendorConfigDataItem();
    message.key = object.key ?? "";
    message.textValue = object.textValue ?? undefined;
    return message;
...
function createBaseVendorConfigData(): VendorConfigData {
  return { configItem: [] };
}

export const VendorConfigData = {
  encode(message: VendorConfigData, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    for (const v of message.configItem) {
      VendorConfigDataItem.encode(v!, writer.uint32(10).fork()).ldelim();
    }
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): VendorConfigData {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseVendorConfigData();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
          ...
          message.configItem.push(VendorConfigDataItem.decode(reader, reader.uint32()));
          continue;
      }
      if ((tag & 7) === 4 || tag === 0) {
        break;
  ...
  fromJSON(object: any): VendorConfigData {
    return {
      configItem: globalThis.Array.isArray(object?.configItem)
        ? object.configItem.map((e: any) => VendorConfigDataItem.fromJSON(e))
        : [],
    };
  },

  toJSON(message: VendorConfigData): unknown {
    const obj: any = {};
    if (message.configItem?.length) {
      obj.configItem = message.configItem.map((e) => VendorConfigDataItem.toJSON(e));
    }
    return obj;
  },

  create<I extends Exact<DeepPartial<VendorConfigData>, I>>(base?: I): VendorConfigData {
    return VendorConfigData.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<VendorConfigData>, I>>(object: I): VendorConfigData {
    const message = createBaseVendorConfigData();
    message.configItem = object.configItem?.map((e) => VendorConfigDataItem.fromPartial(e)) || [];
    return message;
  },
};
