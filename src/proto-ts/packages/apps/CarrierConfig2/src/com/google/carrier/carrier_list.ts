...
//   protoc               v6.33.0
// source: packages/apps/CarrierConfig2/src/com/google/carrier/carrier_list.proto
...
function createBaseCarrierId(): CarrierId {
  return { mccMnc: "", spn: undefined, imsi: undefined, gid1: undefined, iccid: undefined };
}

export const CarrierId = {
  encode(message: CarrierId, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.mccMnc !== undefined && message.mccMnc !== "") {
    ...
    if (message.iccid !== undefined) {
      writer.uint32(50).string(message.iccid);
    }
    return writer;
  },
  ...
  fromJSON(object: any): CarrierId {
    return {
      mccMnc: isSet(object.mccMnc) ? globalThis.String(object.mccMnc) : "",
      spn: isSet(object.spn) ? globalThis.String(object.spn) : undefined,
      imsi: isSet(object.imsi) ? globalThis.String(object.imsi) : undefined,
      gid1: isSet(object.gid1) ? globalThis.String(object.gid1) : undefined,
      iccid: isSet(object.iccid) ? globalThis.String(object.iccid) : undefined,
    };
  },
...
export const CarrierMap = {
  ...
  fromJSON(object: any): CarrierMap {
    return {
      ...
      carrierId: globalThis.Array.isArray(object?.carrierId)
        ? object.carrierId.map((e: any) => CarrierId.fromJSON(e))
        : [],
    };
  },
...
export const CarrierList = {
  ...
  fromJSON(object: any): CarrierList {
    return {
      entry: globalThis.Array.isArray(object?.entry) ? object.entry.map((e: any) => CarrierMap.fromJSON(e)) : [],
